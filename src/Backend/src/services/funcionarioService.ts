    ...
    public async logginFuncionario(dadosLoggin: IFuncionarioLoggin) {
        try {
            ...
            if (!funcionario.func_is_admin) {
                ...
                const token = jwt.sign({ func_id: funcionario.func_id, nivelAcesso: 'atendente' }, secret2)
            ...
            const token = jwt.sign({ func_id: funcionario.func_id, nivelAcesso: 'administrador' }, secret3)
